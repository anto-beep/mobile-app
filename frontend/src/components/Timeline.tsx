...
const makeStyles = (c: ColorPalette) => StyleSheet.create({
  ...
  cellTitle: { fontFamily: Fonts.body, fontSize: 14, color: c.textSecondary, marginTop: 4, lineHeight: 20 },
  cellBody: { ...Type.caption, color: c.textMuted, marginTop: 2, lineHeight: 18 },
