            ...
            <>
              ...
              <View style={styles.appLinks}>
                <TouchableOpacity onPress={() => Linking.openURL('https://apps.apple.com/app/google-authenticator/id388497605')} style={styles.appLink}>
                  <Ionicons name="logo-apple-appstore" size={14} color={c.brandPrimary} />
                ...
                <TouchableOpacity onPress={() => Linking.openURL('https://play.google.com/store/apps/details?id=com.google.android.apps.authenticator2')} style={styles.appLink}>
                  <Ionicons name="logo-google-playstore" size={14} color={c.brandPrimary} />
          ...
          {step === 'verify' && (
            <>
              ...
              <TouchableOpacity style={[styles.primary, busy && { opacity: 0.6 }]} onPress={onVerify} disabled={busy} testID="setup-verify-submit">
                {busy ? <ActivityIndicator color={c.cream} /> : <Text style={styles.primaryText}>Verify & finish setup</Text>}
              </TouchableOpacity>
...
function makeStyles(c: ColorPalette) { return StyleSheet.create({
  ...
  title: { fontFamily: Fonts.heading, fontSize: 26, color: c.brandPrimary, letterSpacing: -0.5, marginBottom: 6 },
  ...
  helperLabel: { fontFamily: Fonts.bodyMed, fontSize: 11, color: c.textMuted, letterSpacing: 0.5, textTransform: 'uppercase', marginBottom: 6, marginTop: 8 },
  secretBox: { flexDirection: 'row', alignItems: 'center', justifyContent: 'space-between', backgroundColor: c.cardBg, borderRadius: Radius.md, borderWidth: 1, borderColor: c.border, paddingHorizontal: Spacing.md, paddingVertical: 12 },
  secretText: { flex: 1, fontFamily: Fonts.bodySemi, fontSize: 14, color: c.brandPrimary, letterSpacing: 1.2 },
  ...
  appLinkText: { fontFamily: Fonts.bodyMed, fontSize: 12, color: c.brandPrimary },
  ...
  primary: { backgroundColor: c.brandPrimary, borderRadius: Radius.md, paddingVertical: 14, alignItems: 'center', minHeight: 48, marginTop: Spacing.md },
  ...
  codeCell: { flexBasis: '47%', flexGrow: 1, paddingVertical: 10, paddingHorizontal: 14, backgroundColor: c.cardBg, borderRadius: Radius.sm, borderWidth: 1, borderColor: c.border, alignItems: 'center' },
  codeCellText: { fontFamily: Fonts.bodySemi, fontSize: 14, color: c.brandPrimary, letterSpacing: 1.2 },
  ...
  secondaryText: { fontFamily: Fonts.bodySemi, fontSize: 13, color: c.brandPrimary },
  warnBox: { flexDirection: 'row', gap: 8, padding: Spacing.md, backgroundColor: 'rgba(183, 121, 31, 0.1)', borderLeftWidth: 3, borderLeftColor: c.brandSecondary, borderRadius: Radius.sm, marginTop: Spacing.md },
  warnText: { flex: 1, fontFamily: Fonts.body, fontSize: 12, color: c.brandPrimary, lineHeight: 17 },
});
