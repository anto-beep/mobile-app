...
const styles = StyleSheet.create({
  ...
  assignBtn: { flexDirection: 'row', alignItems: 'center', gap: 4, paddingHorizontal: 10, paddingVertical: 6, borderRadius: 100, backgroundColor: 'rgba(31, 58, 95, 0.06)' },
  assignText: { fontFamily: Fonts.bodyMed, fontSize: 11, color: Colors.brandPrimary },
  userCard: { flexDirection: 'row', alignItems: 'center', gap: 10, marginHorizontal: Spacing.md, marginTop: Spacing.sm, padding: Spacing.sm, backgroundColor: 'rgba(31, 58, 95, 0.04)', borderRadius: Radius.sm },
  ...
  bubbleInternal: { backgroundColor: 'rgba(212, 162, 78, 0.15)', borderLeftWidth: 3, borderLeftColor: Colors.brandSecondary, alignSelf: 'flex-end' },
  ...
  actionBtn: { flexDirection: 'row', alignItems: 'center', gap: 4, paddingHorizontal: 8, paddingVertical: 6, borderRadius: 100, backgroundColor: 'rgba(31, 58, 95, 0.06)' },
  actionBtnActive: { backgroundColor: 'rgba(212, 162, 78, 0.15)' },
  ...
  modalBackdrop: { flex: 1, backgroundColor: 'rgba(31, 58, 95, 0.5)' },
  ...
  macrosHandle: { width: 40, height: 4, backgroundColor: 'rgba(31,58,95,0.18)', borderRadius: 2, alignSelf: 'center', marginBottom: Spacing.sm },
