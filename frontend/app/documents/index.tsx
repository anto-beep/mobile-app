...
const styles = StyleSheet.create({
  ...
  meterTrack: { height: 6, borderRadius: 3, backgroundColor: 'rgba(31, 58, 95, 0.08)', overflow: 'hidden' },
  ...
  docIcon: { width: 36, height: 36, borderRadius: 18, alignItems: 'center', justifyContent: 'center', backgroundColor: 'rgba(31, 58, 95, 0.06)' },
