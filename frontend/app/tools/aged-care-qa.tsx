    ...
    <SafeAreaView style={styles.safe} edges={['top']} testID="aged-care-qa">
      ...
      <KeyboardAvoidingView behavior={Platform.OS === 'ios' ? 'padding' : 'height'} style={{ flex: 1 }} keyboardVerticalOffset={Platform.OS === 'ios' ? 90 : 0}>
        ...
        <View style={styles.composer}>
          <TextInput style={styles.input} value={draft} onChangeText={setDraft} placeholder="Ask anything about Support at Home…" placeholderTextColor={Colors.textMuted} multiline testID="aged-care-qa-input" />
...
const styles = StyleSheet.create({
  ...
  h1: { fontFamily: Fonts.heading, fontSize: 20, color: Colors.brandPrimary, letterSpacing: -0.3, marginTop: 2 },
  tagline: { fontFamily: Fonts.body, fontSize: 13, color: Colors.textSecondary, marginTop: 4, lineHeight: 18 },
  boundary: { fontFamily: Fonts.body, fontSize: 11, color: Colors.textMuted, marginTop: Spacing.sm, marginBottom: Spacing.sm, lineHeight: 15, fontStyle: 'italic' },
