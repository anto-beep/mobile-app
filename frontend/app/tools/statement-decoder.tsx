...
const styles = StyleSheet.create({
  ...
  summaryCard: { backgroundColor: 'rgba(212, 162, 78, 0.08)', borderRadius: Radius.md, padding: Spacing.md, marginBottom: Spacing.md, borderLeftWidth: 3, borderLeftColor: Colors.brandSecondary },
