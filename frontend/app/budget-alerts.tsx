    ...
    <SafeAreaView style={styles.safe} edges={['top', 'bottom']}>
      ...
      >
        <View style={styles.heroRow}>
          <Ionicons name="alert-circle-outline" size={22} color={Colors.brandPrimary} />
...
const styles = StyleSheet.create({
  ...
  cta: { marginTop: Spacing.sm, paddingHorizontal: 18, paddingVertical: 10, borderRadius: 999, backgroundColor: Colors.brandPrimary },
