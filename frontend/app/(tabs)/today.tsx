...
function makeStyles(c: ColorPalette) { return StyleSheet.create({
  ...
  latestTitle: { fontFamily: Fonts.bodySemi, fontSize: 14, color: c.textPrimary, marginTop: 6, letterSpacing: 0.2 },
  latestSummary: { fontFamily: Fonts.body, fontSize: 13, color: c.textSecondary, marginTop: 4, lineHeight: 19 },
